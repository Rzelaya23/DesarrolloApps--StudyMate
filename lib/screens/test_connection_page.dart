// lib/screens/test_connection_page.dart
import 'package:flutter/material.dart';
import '../core/api/test_connection_service.dart';
...
class _TestConnectionPageState extends State<TestConnectionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.all(16), // ← aquí estaba el error: debe ser padding:
        child: Column(
          children: [
            ElevatedButton(
